...
// data.forEach(d => {
//   if (obj[d.area_name + d.state]) {
//     obj[d.area_name + d.state] += 1
//   } else {
//     obj[d.area_name + d.state] = 1
//   }
// })
...
// data.forEach(d => {
//   if (dataObj[d.state]) {
//     dataObj[d.state] += d.bachelorsOrHigher
//   } else {
//     dataObj[d.state] = d.bachelorsOrHigher
//   }
// })

// const stateDataArr = Object.keys(dataObj).map(k => ({
//   state: k,
//   bachelorsOrHigher: dataObj[k],
// }))

// const csvContent = papa.unparse(stateDataArr)

// fs.writeFileSync('data.csv', csvContent)

// const usStatesPostalAbbr = fs.readFileSync('us_postal_abbr.csv', 'utf8')
// // console.log(usStatesPostalAbbr)
// const dataUSSPA = papa.parse(usStatesPostalAbbr)
// console.log(dataUSSPA)
